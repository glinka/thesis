...
Defined as a set of items and the connections between them
...
sensititve to price variations \cite{li_spatial_2008}. Applications
...
\cite{Semantic networks and competition: Election year winners and
  losers in U.S. televised presidential debates, 1960–2004} (note that
...
epidiemological models composed of thousands of interacting agents,
...
\cite{erdos_random_1959,chung_connected_2002,watts_collective_1998,
  Barabasi}. In more complicated systems the picture is muddier, and
it would be helpful to have an automated method of identifying whether
such a simplified description is present. Towards this end, we extend the
