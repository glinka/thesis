...
the Michaelis-Menten system modeling enzymatic action \cite{The
  Original Michaelis Constant: Translation of the 1913
  Michaelis–Menten Paper}.  In that mechanism, a substrate $S$ is
turned into product $P$ by the action of an enzyme $E$ through the
creation of an intermediate complex $C$,
...
\begin{figure}[!htp]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=0.3\textheight]{f10-f1-phi1} &
    \includegraphics[height=0.3\textheight]{f10-f1-phi2}\\
    (a) & (b) \\
  \end{tabular}
